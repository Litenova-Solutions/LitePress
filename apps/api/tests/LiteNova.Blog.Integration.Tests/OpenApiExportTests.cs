...
namespace LiteNova.Blog.Integration.Tests;
...
public sealed class OpenApiExportTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public OpenApiExportTests(WebApplicationFactory<Program> factory)
    {
        _client = factory.WithWebHostBuilder(builder =>
        {
            ...
            builder.UseSetting("ConnectionStrings:Database", "Host=localhost;Port=5433;Database=blog;Username=blog;Password=blog");
        }).CreateClient();
    }
